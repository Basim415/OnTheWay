...
int main() {
    ...
    auto current_pack = packlist.begin();

    menu_logic(packlist, current_pack);


    return 0;
}

//Debug the markasdelivered
//Fix the formatting of how things are asked and displayed using iomanip, setw, align, and fill
